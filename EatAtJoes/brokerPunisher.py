...
def main(brokerHost, pubtopic, brokerPort=61613):
    """
    """
    bigsleep = 1
    ...
    while True:
        ...
        for i in range(1000000):
            conn.publish(pubtopic, "BOOOOooOOoOOOOOoooOO!", debug=False)
...
if __name__ == "__main__":
    pubtopic = 'RyanIsMeanToTheBroker'

    # dbname = "DCTInfo"
    dbname = None
    brokerHost = 'joe.lowell.edu'

    main(brokerHost, pubtopic)
